...
class Boto3HTML5Translator(SphinxHTML5Translator):
    """Extension of Sphinx's ``HTML5Translator`` for Boto3 documentation."""
...
def setup(app):
    ...
    app.set_translator("html", Boto3HTML5Translator)
