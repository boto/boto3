...
To guess ContentType based on key extension::

s3.upload_file(
    'tmp.txt', 'bucket-name', 'key-name', GuessContentType=True
)

The ``mimetypes`` library will be used to guess the correct ContentType.
